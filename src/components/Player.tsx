				...
				<div class="hidden md:flex flex-1 flex-col items-center justify-center gap-2">
					...
					<div class="flex w-full max-w-md items-center gap-2 text-xs text-muted-foreground">
						...
						>
							...
							<SliderThumb class="top-[-6px] block h-4 w-4 rounded-full border-2 border-primary bg-primary-foreground ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" />
						</Slider>

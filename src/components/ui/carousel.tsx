...
const Carousel: Component<CarouselProps & ComponentProps<"section">> = (
	rawProps,
) => {
	const props = mergeProps<(CarouselProps & ComponentProps<"section">)[]>(
...
const CarouselPrevious: Component<CarouselButtonProps> = (rawProps) => {
	...
	return (
		<Button
			...
			size={local.size}
			class={cn(
				"absolute size-8 touch-manipulation rounded-none",
				orientation === "horizontal"
